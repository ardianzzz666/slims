...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
  ...
  $html_str .= '.leftSide { display: table-cell; float: left; width: 33%; text-align: center; margin-top: 20px; margin-left: 4px; }'."\n";
  ...
  $html_str .= '.callnumb { font-size: 11pt; font-weight: bold; float: right; display: table-cell; text-align: left; margin-top: 4px; width: 3.5cm; }'."\n";
